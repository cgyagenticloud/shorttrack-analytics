#!/usr/bin/env python3
"""
Parse US Speed Skating Short Track PDFs for 2023-2026 seasons
...
def main():
    ...
    output_path = output_dir / "2023-2026.json"
    ...
    all_competitions.sort(key=lambda x: x.get("date") or "", reverse=True)
