#!/usr/bin/env python3
"""
Parse US Speed Skating Short Track PDFs for 2019-2023 seasons
...
# Target seasons: 2019-2020, 2020-2021, 2021-2022, 2022-2023
TARGET_SEASONS = ["2022-2023", "2021-2022", "2020-2021", "2019-2020"]
...
def download_pdf(url, temp_dir):
    ...
    # Fix malformed URL
    if 'https://www.usspeedskating.org' in url and 'https://assets.contentstack.io' in url:
...
def main():
    ...
    output_path = output_dir / "2019-2023.json"
    ...
    print(f"Found {len(competitions)} short track competitions in target seasons")
    ...
    all_competitions.sort(key=sort_key, reverse=True)
